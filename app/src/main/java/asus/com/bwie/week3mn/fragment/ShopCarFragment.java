...
import asus.com.bwie.week3mn.adapter.ShangPinAdapter;
import asus.com.bwie.week3mn.bean.ShopCarBean;
...
public class ShopCarFragment extends Fragment implements IView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.shopcarf_layout, container, false);




        shopCarRecyclerView = view.findViewById(R.id.shopCarRecycle);
        ...
        ipresenter.get(Apis.ShopCarPath+"?labelId=1003&page=1&count=10",ShopCarBean.class);
